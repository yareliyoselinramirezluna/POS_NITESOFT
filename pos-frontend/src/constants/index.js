...
export const metricsData = [
  { title: "Ganancias", value: "$0", color: "#02ca3a", isIncrease: true },
  { title: "Total de Clientes", value: "0", color: "#f6b100", isIncrease: true },
  { title: "Devoluciones", value: "0", color: "#be3e3f", isIncrease: true },
];

export const itemsData = [
  { title: "Categorias", value: "2", color: "#5b45b0", isIncrease: false },
  { title: "Stock Total", value: "340", color: "#285430", isIncrease: true },
  { title: "Mermas", value: "0", color: "#735f32", isIncrease: true },
  { title: "Medicamentos", value: "10", color: "#7f167f"}
];
